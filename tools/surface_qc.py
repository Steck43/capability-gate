...
RULES = [
    ...
    ("OVER-09", "WARN", "line",
     r"jailed boot measured|measured jailed boot", None,
     "The ~958 ms figure is unverified from the current workspace.",
     "Drop the word measured."),

    ("OVER-10", "BLOCK", "line",
     r"\bin production\b|\bmy agent is safe\b|\bsecured my agent\b", None,
     "Kill-list phrasing.",
     "Configured enforce, own profile, named scope."),

    ("OVER-11", "WARN", "line",
     r"\badversarial ML\b", None,
    ...
    ("TAX-02", "BLOCK", "line",
     r"decides what is permitted", None,
    ...
    ("TENURE-01", "WARN", "line",
     r"over six years|6\+ years of Navy", None,
     "Closed by Landen: nearly seven stands, the training pipeline is service time.",
     "Nearly seven years."),

    ("ATTRIB-01", "BLOCK", "line",
     r"Co-Authored-By|generated by (Claude|Cursor|an AI)|AI-generated", None,
